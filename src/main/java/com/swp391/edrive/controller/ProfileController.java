...
public class ProfileController {
    ...
    public ResponseEntity<ResponseObject<ProfileResponse>> getProfile(Authentication auth) {

        ProfileResponse response = profileService.getMyProfile(auth.getName());

        return ResponseEntity.ok(
                ResponseObject.<ProfileResponse>builder()
    ...
    public ResponseEntity<ResponseObject<ProfileResponse>> updateProfile(
            Authentication auth,
